...
5. repos.txt file contains the name of repositories as mentioned above. If a remote repository has been removed or a new one has been added, please modify this file to reflect the updated list of remote repositories accordingly.
